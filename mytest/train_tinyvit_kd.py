...
def main():
    ...
    # 加载带 logits 的数据集
    train_set = CIFAR10WithLogits(root=args.data_root, logits_npz="/kaggle/working/teacher_logits.npz", train=True, transform=transform_train)
    val_set = CIFAR10WithLogits(root=args.data_root, logits_npz="/kaggle/working/teacher_logits_val.npz", train=False, transform=transform_val)
